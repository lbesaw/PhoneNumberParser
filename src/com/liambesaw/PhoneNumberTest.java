...
public class PhoneNumberTest extends TestCase {
    private UseCase useCases[] = {new UseCase("+1(858)775-2868", "+18587752868", "(858)" +
            "775-2868", "+1.858.775.2868"),
    ...
    public void assertValid(UseCase useCase) {
        PhoneNumber ph = PhoneParser.getPhoneNumber(useCase.original);
        assertEquals("[" + useCase.strippedNumber + "]Stripped Number", useCase.strippedNumber, ph.getStrippedValue());
        if (useCase.usa != null) {
